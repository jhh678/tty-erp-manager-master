  ...
  r.fn.qrcode = function (h) {
    ...
    o.prototype = {
      ...
      setupTypeNumber: function (a) {
        for (var c =
            j.getBCHTypeNumber(this.typeNumber), d = 0; d < 18; d++) {
          var b = !a && (c >> d & 1) == 1;
          this.modules[Math.floor(d / 3)][d % 3 + this.moduleCount - 8 - 3] = b;
        }
        for (d = 0; d < 18; d++) b = !a && (c >> d & 1) == 1, this.modules[d % 3 + this.moduleCount - 8 - 3][Math.floor(d / 3)] = b;
      },
      setupTypeInfo: function (a, c) {
        ...
        for (b = 0; b < 15; b++) {
          e = !a && (d >> b & 1) == 1, b < 8 ? this.modules[8][this.moduleCount -
            b - 1
          ] = e : b < 9 ? this.modules[8][15 - b - 1 + 1] = e : this.modules[8][15 - b - 1] = e;
        }
        this.modules[this.moduleCount - 8][8] = !a;
      },
      mapData: function (a, c) {
        for (var d = -1, b = this.moduleCount - 1, e = 7, f = 0, i = this.moduleCount - 1; i > 0; i -= 2) {
          for (i == 6 && i--; ;) {
            for (var g = 0; g < 2; g++) {
    ...
    o.createBytes = function (a, c) {
      for (var d =
        ...
        for (k = 0; k < i[g].length; k++) h = k + n.getLength() - i[g].length, i[g][k] = h >= 0 ? n.get(h) : 0;
      }
    ...
    for (var j = {
        ...
        getBCHTypeNumber: function (a) {
          for (var c = a << 12; j.getBCHDigit(c) -
            j.getBCHDigit(j.G18) >= 0;) c ^= j.G18 << j.getBCHDigit(c) - j.getBCHDigit(j.G18);
          return a << 12 | c;
        },
        getBCHDigit: function (a) {
          for (var c = 0; a != 0;) c++, a >>>= 1;
          return c;
        },
        ...
        getLostPoint: function (a) {
          for (var c = a.getModuleCount(), d = 0, b = 0; b < c; b++) {
            for (var e = 0; e < c; e++) {
              for (var f = 0, i = a.isDark(b, e), g = -1; g <= 1; g++) {
                if (!(b + g < 0 || c <= b + g)) {
