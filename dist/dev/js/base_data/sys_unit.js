$(function () {
  ...
  $('table').GM({
    ...
    supportSorting: true,
    ajax_url: 'http://rap.taobao.org/mockjsdata/29745/api/base_brand/get_unit_list',
    ajax_type: 'POST',
    query: {
      pluginId: 1
    },
    ...
    columnData: [{
      ...
      template: function (action, rowObject) {
        return '<span class="plugin-action del-action" learnLink-id="' + rowObject.id +
          '">删除</span>';
      }
    }],
